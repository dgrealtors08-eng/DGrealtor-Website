...
export function MobileMenu({ isOpen, onClose, scrollToSection }: MobileMenuProps) {
  return (
    <>
      ...
      {/* Menu Panel */}
      <div
        className={`fixed top-0 right-0 z-50 h-full w-[280px] bg-gradient-to-b from-[#FDF8F3] to-[#F5E6D3] shadow-2xl transition-transform duration-500 ease-out lg:hidden ${
