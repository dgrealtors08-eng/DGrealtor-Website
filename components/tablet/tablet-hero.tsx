...
export function TabletHero() {
  ...
  return (
    <section id="hero-tablet" className="relative h-[100svh] flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-20 w-full max-w-4xl mx-auto text-center px-8 flex flex-col justify-center items-center h-full pt-24">
        <div
          className={`transition-all duration-1000 delay-300 ${
            mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
          <h1 className="font-serif text-white text-4xl md:text-5xl font-medium leading-[1.1] mb-8 text-balance drop-shadow-[0_2px_3px_rgba(0,0,0,0.4)]">
        ...
        >
          <button
            onClick={() => {
              const companiesSection = document.getElementById("companies-tablet")
              if (companiesSection) {
